...
import { 
  Heart, Shield, CheckCircle, Calendar, ChevronRight
} from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fadeInLeft">
            <div className="inline-flex items-center px-4 py-2 bg-blue-100 rounded-full mb-6">
              ...
              <span className="ml-2 text-sm font-medium text-blue-800">24/7 Emergency Available</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <button onClick={() => navigate('/doctors')} className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transform transition hover:scale-105 shadow-lg">
                Book Appointment
