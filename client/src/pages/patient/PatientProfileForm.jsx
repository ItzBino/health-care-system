              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.dob ? patient.dob.slice(0, 10) : "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.gender?patient.gender:"Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.phone || "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.bloodGroup === "none" ? "Not specified" : patient.bloodGroup}</p>
                  )}
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.address || "Not provided"}</p>
                  )}
                </div>
              </div>
            </div>
        ...
        (patient.allergies?.length > 0 ? (
          <div className="space-y-2">
            {patient.allergies.map((item, i) => (
              <div key={i} className="flex items-center gap-2 px-3 py-2 bg-white rounded-lg w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.insurance.provider || "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.insurance.policyNumber || "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.insurance.validTill?.slice(0, 10) || "Not provided"}</p>
                  )}
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.emergencyContact.name || "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.emergencyContact.ePhone || "Not provided"}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <p className="px-4 py-2 bg-white rounded-lg">{patient.emergencyContact.relation || "Not provided"}</p>
                  )}
                </div>
              </div>
            </div>
